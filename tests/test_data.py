...
def test_my_dataset_initialization():
    ...
    preprocessed_file = mock_path / "preprocessed_data.csv"
...
def test_preprocess_function():
    ...
    mock_data = {
        "RobinHoodPennyStocks": {
            "raw": {
                "postData": [
                    {"ticker": "AAPL", "title": "Sample", "text": "Test Text", "flair": "bullish", "timestamp": "2022-01-01"},
                    {"ticker": "TSLA", "title": "Sample", "text": "Another Text", "flair": "bearish", "timestamp": "2022-01-02"}
                ]
            }
        }
    }
